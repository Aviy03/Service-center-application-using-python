...
scn=Label(t,text='Electronic Service Center Admin Login Page',width='100',bg='Orange',fg='black')
scn.place(x=0,y=50)
scn.config(font=('Helvetica bold',20))

c=Canvas(t,height=200,width=200,bg='black')
c.place(x=350,y=90)
img=PhotoImage(file='admin.gif')
c.create_image(100,100,image=img)

ad=Label(t,text='Admin ID',bg='WhiteSmoke')
ad.place(x=600,y=150)

adi=Entry(t,width=40,)
adi.place(x=700,y=150)

pwd=Label(t,text='Admin Password',bg='WhiteSmoke')
pwd.place(x=600,y=200)

passi=Entry(t,width=40,show='*')
passi.place(x=700,y=200)
...
def check():
    ...
    if psc=='root':
        ...
        def choice():
            ...
            if ch==0: 
                ...
                def enterdetails():
                    ...
                    close=Button(p,text='Close Application',command=clsap)
        ...
        aa=IntVar()
        r1=Radiobutton(t,text='Enter New Product Category Details',bg='skyblue',variable=aa,value=0,command=choice)
        r2=Radiobutton(t,text='Enter New Product Details',bg='skyblue',variable=aa,value=1,command=choice)
        r3=Radiobutton(t,text='Enter Service Details',bg='skyblue',variable=aa,value=2,command=choice)
        r4=Radiobutton(t,text='Enter Customer Details',bg='skyblue',variable=aa,value=3,command=choice)
        r5=Radiobutton(t,text='Enter Engineer Details',bg='skyblue',variable=aa,value=4,command=choice)
        r6=Radiobutton(t,text='Enter Staff Details',bg='skyblue',variable=aa,value=5,command=choice)
        r7=Radiobutton(t,text='Enter Complain Details',bg='skyblue',variable=aa,value=6,command=choice)
        
        adh=Label(t,text='Add/Delete Details')
        adh.config(font=('Helvetica bold',18))
        adh.place(x=400,y=350)
        
        r1.place(x=400,y=400)
        r2.place(x=400,y=450)
        r3.place(x=400,y=500)
        r4.place(x=400,y=550)
        r5.place(x=400,y=600)
        r6.place(x=400,y=650)
        r7.place(x=400,y=700)
        
        sh=Label(t,text='Search Details')
        sh.config(font=('Helvetica bold',18))
        sh.place(x=900,y=350)
        
        def productsearch():
            srh=Toplevel()
            srh.geometry('300x300')
            ...
            psb=Button(srh,text='Search',bg='skyblue',command=dis)
        ...
        pds=Button(t,text='Product Details',bg='skyblue',command=productsearch)
        pds.place(x=900,y=400)        
        ...
        eds=Button(t,text='Engineer Details',bg='skyblue',command=engsearch)
        ...
        cds=Button(t,text='Customer Details',bg='skyblue',command=customersearch)
        cds.place(x=900,y=500)
...
close=Button(t,text='Close Application',command=clsap)
close.place(x=890,y=250) 
    

submit=Button(t,text='Submit',bg='WhiteSmoke', command=check)
submit.place(x=700,y=250)


cnl=Button(t,text='Clear',bg='WhiteSmoke',command=clear)
cnl.place(x=800,y=250)
